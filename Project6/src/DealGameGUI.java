                    ...
                    // the user has selected "No"
                        if(game.getRound() == DealGame.NUM_ROUNDS - 1) {
                            int choice = JOptionPane.showConfirmDialog(null, 
                                                               "It is the last round!  Do you " +
                                                               "want to keep your box (YES), or " +
                            ...
                            if(choice == JOptionPane.YES_OPTION) {
                                ...
                                if(otherValue >= value) {
                                    JOptionPane.showMessageDialog(null, 
                                        "You have swapped boxes, and earned " + 
                                                         strOtherValue + 
                                                         ".  Your original box contained " + 
                                                      strValue + ". You have made a GOOD DEAL!", 
                                                      "Game Over", 
                                                      JOptionPane.INFORMATION_MESSAGE);
                                }
                                else {
                        ...
                        if(offer < value) {
                            JOptionPane.showMessageDialog(null, 
                                                          "You have accepted the offer of " + 
                                                          strOffer + 
